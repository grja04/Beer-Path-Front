    ...
    return (
        <Grid>
            <Paper elevation={10} style={paperStyle}>
                ...
                <TextField name="username" onChange={getEntryData} label='Username' placeholder='Enter username' fullWidth required />
                <TextField name="email" onChange={getEntryData} label='Email' placeholder='Enter email' fullWidth required />
                <TextField name="hash" onChange={getEntryData} label='Password' placeholder='Enter passwowrd' type='password' fullWidth required />
